...
def _main():
    ...
    #fire.Fire(main, command='"results/Li-Co-O_test"   --pretrained-name=chemical_system   --batch_size=10   --properties_to_condition_on="{\'chemical_system\':\'Li-Co-O\'}"   --record_trajectories=False   --diffusion_guidance_factor=2.0  --guidance="{\'environment\': {\'mode\':\'l2\',\'Co-O\':6}}" --diffusion_loss_weight=[0.01,0.01,True]   --print_loss=False --self_rec_steps=3 --back_step=2 --algo=False' )
