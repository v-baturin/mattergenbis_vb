...
def _main():
    ...
    fire.Fire(main, command='"results/chemical_system/Pd-Ni-H_temp2"   --pretrained-name=chemical_system   --batch_size=5   --properties_to_condition_on="{\'chemical_system\':\'Pd-Ni-H\'}"   --record_trajectories=False   --diffusion_guidance_factor=2.0   --guidance="{\'volume\': 30.935}"   --diffusion_loss_weight=1   --print_loss=True')
