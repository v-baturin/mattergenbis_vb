...
def _main():
    ...
    #fire.Fire(main, command='"results/Li-Co-O_test"   --pretrained-name=chemical_system   --batch_size=10   --properties_to_condition_on="{\'chemical_system\':\'Li-Co-O\'}"   --record_trajectories=False   --diffusion_guidance_factor=2.0  --guidance="{\'environment\': {\'mode\':\'huber\',\'Co-O\':6}}" --diffusion_loss_weight=500.0   --print_loss=True --self_rec_steps=3 --back_step=2' )
