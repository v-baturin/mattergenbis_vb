...
if [[ -n "$VIRTUAL_ENV" && "$VIRTUAL_ENV" == "$(cd /home/vsbat/work/venvs/mattergenbis_venv && pwd)" ]]; then
    echo "Virtual environment already activated."
else
    echo "Activating the virtual environment..."
    source /home/vsbat/work/venvs/mattergenbis_venv/bin/activate
fi
